...
| **Language awareness** | Limited or none | 53 built-in language profiles |
...
- **[Transliteration](user-guide/transliteration.md)** — Unicode → ASCII with 53 language profiles
...
- **[Language support](user-guide/language-support.md)** — 53 built-in profiles, extensible via `register_lang()`
