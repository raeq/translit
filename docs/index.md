...
| **Language awareness** | Limited or none | 51 built-in language profiles |
...
- **[Transliteration](user-guide/transliteration.md)** — Unicode → ASCII with 51 language profiles
...
- **[Language support](user-guide/language-support.md)** — 51 built-in profiles, extensible via `register_lang()`
