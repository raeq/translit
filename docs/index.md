...
| **Language awareness** | Limited or none | 54 built-in language profiles |
...
- **[Transliteration](user-guide/transliteration.md)** — Unicode → ASCII with 54 language profiles
...
- **[Language support](user-guide/language-support.md)** — 54 built-in profiles, extensible via `register_lang()`
