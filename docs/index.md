...
| **Language awareness** | Limited or none | 56 built-in language profiles |
...
- **[Transliteration](user-guide/transliteration.md)** — Unicode → ASCII with 56 language profiles
...
- **[Language support](user-guide/language-support.md)** — 56 built-in profiles, extensible via `register_lang()`
