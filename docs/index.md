...
| **Language awareness** | Limited or none | 60 built-in language profiles |
...
- **[Transliteration](user-guide/transliteration.md)** — Unicode → ASCII with 60 language profiles
...
- **[Language support](user-guide/language-support.md)** — 60 built-in profiles, extensible via `register_lang()`
