...
- **48,148** mapped by translit vs **47,408** by Unidecode — translit has broader coverage overall, with 924 characters only translit maps vs 184 only Unidecode maps
